...
// GET /observations - List observations with optional pagination and filtering
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    const url = `${FHIR_BASE_URL}/Observation${queryString}`;
...
router.get('/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const url = `${FHIR_BASE_URL}/Observation/${id}`;
